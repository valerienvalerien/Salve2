...
Un entrant en direct se chiffre avec le même outil : la page de projection permet de choisir, contrat par contrat, la grille marque blanche, la fourchette client final du registre interne, ou un prix saisi à la main. Le mode direct sert à répondre à une demande entrante au tarif en vigueur ; il ne rouvre pas la prospection directe, gelée depuis le 2026-09-07. Il ne porte pas non plus de coût d'acquisition par défaut : en direct, ce coût existe et se saisit dans le champ prévu.
