...
> "C'est pour ça qu'on démarre sur un périmètre restreint, avec une sortie à 30 jours pendant les trois premiers mois. Vous n'avez pas besoin de nous croire sur parole — vous avez besoin de KPIs réels sur vos propres tickets, et de pouvoir arrêter si ça ne va pas. Et on adosse un avoir de 20 % si les SLA ne sont pas tenus en régime : on met notre argent sur le résultat. Le dispositif qualité est écrit avant le premier ticket : script validé avec vous, double écoute hebdomadaire, reporting mensuel chiffré. Vous jugez sur pièces, pas sur notre taille."
