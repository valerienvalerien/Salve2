...
| Support N1 SaaS | « **≥ 90 % des tickets N1 du périmètre** reçoivent une première réponse **< 30 min ouvrées** et **≥ 70 % sont résolus au N1** sans escalade éditeur, sur les plages 8h-20h. Grille QA et double écoute pilotées par Salverys, restituées au reporting mensuel. **Manqué ⇒ avoir de 20 %** (mêmes conditions) » | la file de tickets N1 | FRT + taux de résolution N1, agrégés | Salverys arbitre la file selon les règles de priorisation **figées au cadrage**, pas selon les demandes du jour | mensuel, à compter du 1er mois plein |
