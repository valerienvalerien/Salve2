...
>
> **Statut : prestation INDÉPENDANTE.** Ceci n'est **pas** un contrat de travail salarié.
...
STAT **74908 11 2023 0 06077**, RCS **102071032469**, dont le siège social est situé
**Lot IIE 21 A ter, Antananarivo (Madagascar)**, représentée par **Valérien Rakotosalama**,
en sa qualité de **Gérant**, dûment habilité.
...
relation client. Les Parties se rapprochent pour confier à la Prestataire, en toute
**indépendance**, une mission de développement commercial, dans les conditions ci-après.

Les Parties ont préalablement signé un **accord de confidentialité (NDA)** référencé
**NDA-CONSULTANT-VIV0010-Randrianasinoro**, qui demeure pleinement en vigueur et est
annexé au présent contrat (Annexe 1). Le présent contrat **ne réécrit pas** le NDA mais
s'y articule (cf. art. 8).

---

## Article 1 — Objet et statut indépendant

1.1. La Société confie à la Prestataire, qui l'accepte, une **prestation de services de
développement commercial B2B** pour le compte de Salverys, dans les conditions définies
ci-après.

1.2. La Prestataire intervient en qualité de **prestataire indépendante**. Le présent
contrat **n'emporte aucun lien de subordination** ni aucune relation de travail salarié
...
(ciblage, messages, canaux) et un **rétroplanning** opérationnel. Ce livrable est régi,
pour ce qui concerne sa propriété et sa cession, par le NDA (Annexe 1, cession des
livrables).

2.4. La Prestataire est tenue d'une **obligation de moyens**. Elle met en œuvre les
...
ouvrant plusieurs niches ou plusieurs ETP ne donne droit qu'à **une seule** commission.

3.3. La commission est due à la Prestataire dès lors que le Contrat gagné résulte de son
action de prospection / closing au cours de la mission. En cas de doute sur l'origine d'un
contrat, les Parties s'accordent de bonne foi sur la base des traces du CRM.
...
4.2. **Commission de performance** : prime **« one-shot » DÉPLAFONNÉE** de **400 €**
(quatre cents euros, soit **≈ 2 000 000 Ar** au taux de référence ~5 000 Ar = 1 €),
...
5.1. La Prestataire **émet une facture mensuelle** récapitulant les honoraires fixes et,
le cas échéant, la (les) commission(s) de performance due(s) au titre du mois.
...
(courriel avec accusé suffisant). Pendant le préavis, la mission se poursuit dans des
conditions normales.
...
(Annexe 1). Les commissions afférentes à des « Contrats gagnés » dont les conditions
(art. 3.1) étaient réunies **avant** la date d'effet de la résiliation restent **dues**.

## Article 7 — Loyauté et non-concurrence limitée (pendant la mission)

7.1. **Pas d'exclusivité totale.** La Prestataire conserve la liberté d'exercer pour
d'autres clients **non concurrents** de la Société. Aucune obligation d'exclusivité
générale ne lui est imposée.

7.2. **Non-concurrence limitée pendant la durée de la mission.** Pendant toute l'exécution
...
commerciales de la Société à son profit ou au profit d'un tiers concurrent.

7.4. **Non-sollicitation.** La non-sollicitation des contacts, prospects et clients de la
...
8.1. Les obligations de **confidentialité** (durée **3 ans**), de **non-sollicitation**
(durée **24 mois**) et de **cession des livrables / propriété intellectuelle** sont
...
au NDA et au DPA le cas échéant.

## Article 10 — Indépendance des stipulations

Si l'une des stipulations du présent contrat était jugée nulle ou inapplicable, les autres
stipulations conserveraient leur plein effet. Les Parties s'efforceraient de remplacer la
clause invalidée par une clause valide poursuivant un objectif équivalent.

## Article 11 — Droit applicable et règlement des litiges

11.1. Le présent contrat est régi par le **droit malgache**.

11.2. En cas de différend relatif à sa formation, son interprétation, son exécution ou sa
...
11.3. **À défaut d'accord amiable** à l'expiration de ce délai, le litige sera porté
devant les **tribunaux compétents d'Antananarivo (Madagascar)**, auxquels les Parties
attribuent expressément compétence.

---

## Annexes

- **Annexe 1** — Accord de confidentialité signé : `NDA-CONSULTANT-VIV0010-Randrianasinoro`
  (confidentialité 3 ans · non-sollicitation 24 mois · cession des livrables · clause
  pénale 20 000 000 Ar · statut indépendant art. 7).
- **Annexe 2** _(le cas échéant)_ — Accord de traitement de données (DPA).

---

## Signatures

| La Société (VJUS — nom commercial Salverys) | La Prestataire |
|---|---|
| Nom : Valérien Rakotosalama | Nom : Vololoniaina Randrianasinoro |
| Qualité : Gérant | Qualité : Consultante indépendante (business development) |
| Date : [JJ/MM/AAAA] | Date : [JJ/MM/AAAA] |
| Signature : | Signature : |

> _Mention manuscrite recommandée pour chaque Partie : « Lu et approuvé, bon pour accord »._
