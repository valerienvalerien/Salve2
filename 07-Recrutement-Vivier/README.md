...
Cible : les profils des 3 niches + les 2 référents d'exploitation — **à partir de
2 500 000 Ar/mois (500 €) brut, en CDI**, bande jusqu'à 3 250 000 Ar (équipe 100 % salariée
depuis le 2026-08-14, bande salariale révisée le 2026-09-02, cf. `CLAUDE.md`), objectif
**zéro turnover**. Fiche de poste de l'encadrant :
`FICHE-POSTE-Referent-Exploitation.md`. On recrute des **salariés**, pas des freelances : le sourcing reste
