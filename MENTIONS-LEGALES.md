# MENTIONS-LEGALES.md — Salverys / VJUS

> **Source unique de vérité** pour l'identité légale. Toute mention légale, CGV, facture,
> contrat et footer de site doit s'aligner sur ce fichier ; en cas de divergence, ce
> document fait foi. Les champs marqués _(à compléter)_ doivent être renseignés avant
> publication ou signature.
...
- **Public** : exclusivement **professionnels** (B2B). Pas de B2C → **pas de droit de
  rétractation consommateur**.
- **Droit applicable** : **droit malgache**. **Pas de juridiction française.**
- **Règlement des litiges** : clause **à deux étages selon la taille du contrat**
  (cf. CGV) :
...
Prestation de services **B2B** d'une société **malgache** (hors UE) vers des clients
**professionnels français** :

- En principe **TVA non applicable** côté VJUS (prestation hors champ de la TVA
  française) ; le client professionnel français relève généralement de
  l'**autoliquidation de TVA**.
- Mention de facture à prévoir : « **TVA non applicable** » + référence légale.
- **À faire valider par le comptable** avant émission des premières factures et reprise
  dans la clause prix/TVA des CGV.

## Hébergement du site

Le site est hébergé par **OVH SAS**, 2 rue Kellermann, 59100 Roubaix, France.

_(à compléter — vérifier l'offre OVH souscrite et la raison sociale exacte à reprendre
dans la mention, puis faire valider l'ensemble du bloc par le comptable/juriste.)_
