...
| `02-Prospection/` | Séquences cold (`OUTREACH-*`) + one-pagers (chaînes médical, partenaire MB) + playbooks de sourcing (`PLAYBOOK-SALES-NAVIGATOR.md`, `PROMPT-RECHERCHE-PROSPECTS-IT-Canada.md`) |
