...
| `02-Prospection/` | Séquences cold (`OUTREACH-*`), scripts d'appel, one-pagers, **`PLAYBOOK-SALES-NAVIGATOR.md`** (méthode de prospection en production), **`BAROMETRE-EXTERNALISATION-N1.md`** (protocole d'entretiens marché), **`ACCES-DECIDEURS.md`** (obtenir du temps d'un décideur — note de cadrage) |
